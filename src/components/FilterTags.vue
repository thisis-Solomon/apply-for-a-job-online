<template>
  <section
    ...
    class="absolute -top-[100px] flex w-full justify-between items-center bg-white rounded-md px-10 py-5 shadow-lg shadow-dark-grayish-cyan/10"
  >
    ...
    <button
      @click="clearFilters"
      class="py-0.5 px-3 text-desaturated-dark-cyan font-bold hover:underline"
    >
      Clear
    </button>
  </section>
